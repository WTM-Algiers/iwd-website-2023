...
const CardMentor = () => {
  ...
  return (
    <div className="w-screen py-16 lg:py-36 lg:px-28 2xl:py-80 2xl:px-52">
                  ...
                  {({ isActive, isNext, isPrev }) => (
                    <div className="flex flex-col lg:flex-row gap-2 items-center lg:py-20 lg:gap-14 lg:px-32">
                      <div className="flex flex-col-reverse items-center gap-4 lg:flex-col">
                        <img
                          src={prs.image}
                          className="w-32 lg:w-60 2xl:w-80"
                        />
                        <div>
                          <div className="relative">
                            <img
                              src={titlecover}
                              className=" absolute right-[104px] w-20 lg:right-0 lg:w-64 2xl:w-96"
                            />
                          </div>
                          <div
                            className="font-bold text-xl px-28
                         lg:text-4xl lg:py-4 lg:px-16 2xl:text-6xl"
                          >
                            {prs.type}
                          </div>
                        </div>
