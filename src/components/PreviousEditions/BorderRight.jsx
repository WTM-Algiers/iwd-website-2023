...
const BorderRight = (
    {word}) =>{
     return(
        <div className="flex flex-row  justify-center  lg:ml-[517px] 2xl:ml-[788px] mt-12 gap-7 lg:gap-x-6 2xl:gap-10 ">
                ...
                <img className="hidden lg:flex 2xl:flex 2xl:w-[850px]" src={line_end_circle_toLeft} alt="" />
                </div>
     )
 }
