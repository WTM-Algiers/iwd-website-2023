...
const BorderRight = ({ word }) => {
  return (
    <div
      data-aos="fade-left"
      className="flex flex-row justify-center items-center lg:ml-[517px] 2xl:ml-[788px] mt-12 gap-7 lg:gap-x-6 2xl:gap-10 "
    >
      <img
      ...
      <img
        className="hidden lg:flex 2xl:flex 2xl:w-[830px]"
