...
const Workshops = () => {
    ...
    return (
        <section>
            <div className="h-screen w-full flex flex-col items-center justify-center lg:justify-start mb-20 ">

                    <div>
                         <h1 className=" font-PTsans font-bold text-3xl  pb-40 lg:pb-0 lg:text-7xl 2xl:text-8xl"> Workshops</h1>
                    </div>
                                                ...
                                                <div className="w-full flex flex-col items-center justify-center space-y-6">
                                                    ...
                                                    <div >
                                                       <div className=" mb-16 relative mx-auto flex px-12 py-3 lg:py-5 lg:px-16  rounded-3xl justify-center ">
                                                           <img src={titlecover} className=" absolute h-10 lg:h-16 lg:w-80 2xl:h-20 2xl:w-[800px] z-10 top-0 lg:top-3" alt="cover" /> 
                                                           <p className="text-center font-semibold text-xs lg:text-xl 2xl:text-3xl lg:p-2"> {wrkshop.description} </p>
                                                        </div>
                                                    </div>
